...
def PySubPlexed(_data):
    ...
    Example return un-tagged results 'unsorted' while still using internal tagging for order.
    """

    return pysubplexed.spawn(int(len(_data)), _data, restrained=False, tag=False, sort=False)
