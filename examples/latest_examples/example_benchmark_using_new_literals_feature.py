...
def PySubPlexed(_data):
    return pysubplexed.spawn(int(len(_data)), _data, restrained=False, allow_literals=True, tag=False, sort=True)
...
""" BenchPySubPlexed took me 1.8196121000073617 seconds on my machine (was taking 16+seconds in previous versions)"""
